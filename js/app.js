...
/***/ function(module, exports, __webpack_require__) {
	...
	var _localStorage = __webpack_require__(/*! ./model/localStorage */ 14);
	
	var _todo = __webpack_require__(/*! ./model/todo */ 5);
	
	var store = new _simpledomComponent.Store({
		todos: (0, _localStorage.fetchTodos)(),
		filter: 'all'
	});
	
	(0, _router.initRouter)(store);
	
	store.subscribe(_todo.SYNC_TO_LOCALSTORAGE, function (event, state) {
		(0, _localStorage.persistTodos)(state.todos);
	});
	
	(0, _simpledomComponent.renderToDom)('todoapp', (0, _simpledomComponent.el)(_TodoApp.TodoApp, null), store);
	...
	var Header = exports.Header = function (_Component) {
		...
		_createClass(Header, [{
			...
			value: function addTodo(event) {
				var todoVal = event.target.value && event.target.value.trim();
				if (todoVal) {
					event.target.value = '';
...
/***/ function(module, exports) {
	...
	var SYNC_TO_LOCALSTORAGE = exports.SYNC_TO_LOCALSTORAGE = 'SYNC_TO_LOCALSTORAGE';
	...
	function updateTodo(store, todoId, title) {
		store.updateState({
			todos: store.state.todos.map(function (storeTodo) {
				return storeTodo.id === todoId ? _extends({}, storeTodo, { editing: false, title: title }) : storeTodo;
			})
	...
	function toggleAll(store, completed) {
		...
		var events = (_ref = [UPDATE_COMPLETE, SYNC_TO_LOCALSTORAGE]).concat.apply(_ref, _toConsumableArray(store.state.todos.map(function (todo) {
			return todo.id;
		}).map(UPDATE_TODO)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ToggleButton = __webpack_require__(/*! ./ToggleButton */ 15);
	...
	var Main = exports.Main = function (_ConnectedComponent) {
		...
		_createClass(Main, [{
			...
			value: function eventsToSubscribe() {
				return [_todo.UPDATE_TODO_LIST, _todo.UPDATE_FILTER];
			}
		}, {
			key: 'filterForTodo',
			value: function filterForTodo() {
			...
			value: function render() {
				...
				return (0, _simpledomComponent.el)(
					'section',
					{ 'class': 'main' },
					(0, _simpledomComponent.el)(_ToggleButton.ToggleButton, null),
					(0, _simpledomComponent.el)(
						'label',
						{ 'for': 'toggle-all' },
					...
					(0, _simpledomComponent.el)(
						'ul',
						{ 'class': 'todo-list' },
						this.state.todos.filter(this.filterForTodo()).map(function (todo) {
	...
	var Todo = exports.Todo = function (_ConnectedComponent) {
		...
		_createClass(Todo, [{
			...
			value: function updateTodo(event) {
				...
				if (value) {
					(0, _todo.updateTodo)(this.store, this.props.todoId, value);
				} else {
					(0, _todo.deleteTodo)(this.store, this.props.todoId);
				}
			}
			...
			value: function render() {
				...
				return (0, _simpledomComponent.el)(
					...
					(0, _simpledomComponent.el)('input', { ref: this.refInputEdit, 'class': 'edit', value: todo.title, onKeyUp: this.handleKeyUp, onBlur: this.updateTodo })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FilterButtons = __webpack_require__(/*! ./FilterButtons */ 11);
		...
		_createClass(Footer, [{
			...
			value: function render() {
				...
				return (0, _simpledomComponent.el)(
					...
					(0, _simpledomComponent.el)(_FilterButtons.FilterButtons, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.FilterButtons = undefined;
	...
	var FilterButtons = exports.FilterButtons = function (_ConnectedComponent) {
		_inherits(FilterButtons, _ConnectedComponent);
	
		function FilterButtons() {
			_classCallCheck(this, FilterButtons);
	
			return _possibleConstructorReturn(this, (FilterButtons.__proto__ || Object.getPrototypeOf(FilterButtons)).apply(this, arguments));
		}
	
		_createClass(FilterButtons, [{
			key: 'eventsToSubscribe',
			value: function eventsToSubscribe() {
				return [_todo.UPDATE_FILTER];
			}
		}, {
			key: 'render',
			value: function render() {
				return (0, _simpledomComponent.el)(
					...
					(0, _simpledomComponent.el)(
						...
						(0, _simpledomComponent.el)(
							'a',
							{ 'class': { selected: this.state.filter === 'all' }, href: '#/' },
							'All'
						)
					),
					(0, _simpledomComponent.el)(
						...
						(0, _simpledomComponent.el)(
							'a',
							{ 'class': { selected: this.state.filter === 'active' }, href: '#/active' },
							'Active'
						)
					),
					(0, _simpledomComponent.el)(
						...
						(0, _simpledomComponent.el)(
							'a',
							{ 'class': { selected: this.state.filter === 'completed' }, href: '#/completed' },
							'Completed'
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rliteRouter = __webpack_require__(/*! rlite-router */ 13);
	...
	function initRouter(store) {
		...
		router.add('', function () {
			return store.updateState({ filter: 'all' }, _todo.UPDATE_FILTER);
		});
		router.add('active', function () {
			return store.updateState({ filter: 'active' }, _todo.UPDATE_FILTER);
		});
		router.add('completed', function () {
			return store.updateState({ filter: 'completed' }, _todo.UPDATE_FILTER);
		});
...
/***/ function(module, exports) {
	...
	exports.persistTodos = persistTodos;
	
	
	var namespace = 'todos-simpledom-component';
	var key = 'todos';
	...
	function persistTodos() {
		...
		localStorage.setItem(namespace + '-' + key, JSON.stringify(todos.map(function (todo) {
			return {
				id: todo.id,
				title: todo.title,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToggleButton = exports.ToggleButton = function (_ConnectedComponent) {
		_inherits(ToggleButton, _ConnectedComponent);
